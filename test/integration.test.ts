...
describe("Runtime validation tests", () => {
  ...
  describe("User validator", () => {
    ...
    test("setup", async () => {
      const userValidator = await import(join(generatedDir, "user-validator.ts"));
  ...
  describe("Complex validator", () => {
    ...
    test("setup", async () => {
      const complexValidator = await import(join(generatedDir, "complex-validator.ts"));
    ...
    test("rejects invalid complex objects", () => {
      const invalidObjects = [
        ...
        { id: 1, name: "Product", price: 100, tags: ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k"] }, // too many
        { id: 1, name: "Product", price: 100, tags: ["a", "a"] }, // duplicates
        
        // Invalid metadata
        { id: 1, name: "Product", price: 100, metadata: {} }, // empty object
        { id: 1, name: "Product", price: 100, metadata: { a: 1, b: 2, c: 3, d: 4, e: 5, f: 6 } }, // too many properties
        
        // Invalid variants
        { id: 1, name: "Product", price: 100, variants: [{ sku: "abc", attributes: {} }] }, // invalid SKU pattern
  ...
  describe("Ref validator", () => {
    ...
    test("rejects invalid ref objects", () => {
      const invalidObjects = [
        ...
        // Invalid zipCode
        { id: 1, name: "John", address: { street: "123 Main St", city: "New York", zipCode: "123" } }, // too short
        { id: 1, name: "John", address: { street: "123 Main St", city: "New York", zipCode: "1234a" } }, // not digits
        
        // Invalid workAddress
        { id: 1, name: "John", address: { street: "123 Main St", city: "New York" }, workAddress: { street: "456 Elm St" } },
      ];
